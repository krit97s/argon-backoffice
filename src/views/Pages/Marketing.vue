...
// Tables
import PageVisitsTable from '../marketing/PageVisitsTable.vue';
...
export default {
  ...
  computed: {
    ...mapState({
      marketing: (state) => state.marketing.marketingList,
      marketingMeta: (state) => state.marketing.marketingMeta,
    })
  },
  data() {
    return {

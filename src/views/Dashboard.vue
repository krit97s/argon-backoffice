  ...
  <div>
    ...
    <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-primary">
      ...
      <div class="d-flex flex-sm-row flex-column mb-2 mb-sm-0">
        <div class="d-sm-flex">
          <base-input type="month" input-classes="form-control-sm" v-model="startDate" id="example-month-input" />
          <base-input type="month" input-classes="form-control-sm" class="ml-1 " v-model="endDate"

<template>
  <div>
    ...
    <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-primary">
      ...
      <b-row>
        <b-col xl="3" md="6">
          <stats-card title="กำไร" type="gradient-green" sub-title="350,897" icon="ni ni-money-coins" class="mb-4">
            <template slot="footer">
              <!-- <div class="text-success mr-2">3.48%</div> -->
              <div class="text-nowrap text-right">12/2022</div>
            </template>
          </stats-card>
        </b-col>
        <b-col xl="3" md="6">
          <stats-card title="ยอดเติมเงิน" type="gradient-purple" sub-title="2,356" icon="ni ni-cart" class="mb-4">
            <template slot="footer">
        ...
        <b-col xl="3" md="6">
          <stats-card title="ยอดลงทุน" type="gradient-primary" sub-title="924" icon="ni ni-chart-pie-35" class="mb-4">
            <template slot="footer">
        ...
        <b-col xl="3" md="6">
          <stats-card title="เคริตคงเหลือ" type="gradient-info" sub-title="523" icon="ni ni-credit-card" class="mb-4">
            <template slot="footer">
              <!-- <div class="text-success mr-2">523</div> -->
              <div class="text-nowrap ml-auto text-right">12/2022</div>
            </template>
          </stats-card>
        </b-col>
      </b-row>
